...
var audioCol = new Audio(
  "https://freesound.org/data/previews/321/321262_5260872-lq.mp3"
);
var audioWin = new Audio(
  "https://freesound.org/data/previews/277/277021_1402315-lq.mp3"
);
var audioLoose = new Audio(
  "https://freesound.org/data/previews/335/335906_5865517-lq.mp3"
);
var audio10sec = new Audio(
  "https://cdn.glitch.com/976cf13a-2711-44df-94e9-88da116434d8%2F10%20Seconds%20Countdown.wav?v=1598987242349"
);
var arr = [];
var time;
...
function resetBeers() {
  document
    .getElementsByClassName("beer")[0]
    .setAttribute("position", "6 6.4 65");
  document
    .getElementsByClassName("beer")[1]
    .setAttribute("position", "-16 6.4 65");
  document
    .getElementsByClassName("beer")[2]
    .setAttribute("position", "16 6.4 55");
  document
    .getElementsByClassName("beer")[3]
    .setAttribute("position", "-6 6.4 55");
  document
    .getElementsByClassName("beer")[4]
    .setAttribute("position", "-26 6.4 55");

  document
    .getElementsByClassName("beer")[5]
    .setAttribute("position", "16 1 95");
  document
    .getElementsByClassName("beer")[6]
    .setAttribute("position", "18 1 95");
  document
    .getElementsByClassName("beer")[7]
    .setAttribute("position", "20 1 95");

  document
    .getElementsByClassName("beer")[8]
    .setAttribute("position", "52 2.9 80");
  document
    .getElementsByClassName("beer")[9]
    .setAttribute("position", "26 6.4 65");
  document
    .getElementsByClassName("beer")[10]
    .setAttribute("position", "-65 1 65");

  document
    .getElementsByClassName("beer")[11]
    .setAttribute("position", "-46.5 2.9 25");
  document
    .getElementsByClassName("beer")[12]
    .setAttribute("position", "-46.5 2.9 27.7");

  document
    .getElementsByClassName("beer")[13]
    .setAttribute("position", "-48.5 2.5 8.2");
  document
    .getElementsByClassName("beer")[14]
    .setAttribute("position", "-46.5 2.5 8");
  document
    .getElementsByClassName("beer")[15]
    .setAttribute("position", "-40.5 3.5 88.5");

  document
    .getElementsByClassName("beer")[16]
    .setAttribute("position", "-30.5 5.9 89");
  document
    .getElementsByClassName("beer")[17]
    .setAttribute("position", "-20.5 3.5 91.5");
  document
    .getElementsByClassName("beer")[18]
    .setAttribute("position", "-98 1 -87.78");

  document
    .getElementsByClassName("beer")[19]
    .setAttribute("position", "-18 5.9 -5.5");
  document
    .getElementsByClassName("beer")[20]
    .setAttribute("position", "-23 3.5 -4.2");
  document
    .getElementsByClassName("beer")[21]
    .setAttribute("position", "18 3.5 -4.2");

  document
    .getElementsByClassName("beer")[22]
    .setAttribute("position", "23 3.5 -5.5");
  document
    .getElementsByClassName("beer")[23]
    .setAttribute("position", "16 5.9 0");
  document
    .getElementsByClassName("beer")[24]
    .setAttribute("position", "21 5.9 0");

  document
    .getElementsByClassName("beer")[25]
    .setAttribute("position", "0 1 33");
  document
    .getElementsByClassName("beer")[26]
    .setAttribute("position", "27 1 21");
  document
    .getElementsByClassName("beer")[27]
    .setAttribute("position", "69 5.9 -35");

  document
    .getElementsByClassName("beer")[28]
    .setAttribute("position", "74 6.9 -36");
  document
    .getElementsByClassName("beer")[29]
    .setAttribute("position", "72 4.9 -32 ");
  document
    .getElementsByClassName("beer")[30]
    .setAttribute("position", "20 35.5 -76");

  document
    .getElementsByClassName("beer")[31]
    .setAttribute("position", "40 45.5 -86");
  document
    .getElementsByClassName("beer")[32]
    .setAttribute("position", "55 4.9 39");
  document
    .getElementsByClassName("beer")[33]
    .setAttribute("position", "60 5.9 37");

  document
    .getElementsByClassName("beer")[34]
    .setAttribute("position", "65 6.9 35");
  document
    .getElementsByClassName("beer")[35]
    .setAttribute("position", "72.2 2.25 60");
  document
    .getElementsByClassName("beer")[36]
    .setAttribute("position", "71 2.25 49");

  document
    .getElementsByClassName("beer")[37]
    .setAttribute("position", "53 2.25 11");
  document
    .getElementsByClassName("beer")[38]
    .setAttribute("position", "52 2.25 9.5");
  document
    .getElementsByClassName("beer")[39]
    .setAttribute("position", "52 2.25 20.5");

  document
    .getElementsByClassName("beer")[40]
    .setAttribute("position", "-71 21 79");

  document
    .getElementsByClassName("beer")[41]
    .setAttribute("position", "-91 11 98");
  document
    .getElementsByClassName("beer")[42]
    .setAttribute("position", "-91 11 88");
  document
    .getElementsByClassName("beer")[43]
    .setAttribute("position", "-80 16.5 -76");
  document
    .getElementsByClassName("beer")[44]
    .setAttribute("position", "-70 11.5 -71");
  document
    .getElementsByClassName("beer")[45]
    .setAttribute("position", "-52.5 1 -85");
  document
    .getElementsByClassName("beer")[46]
    .setAttribute("position", "81 11 89");
  document
    .getElementsByClassName("beer")[47]
    .setAttribute("position", "-6.5 25.8 -65.5");
  document
    .getElementsByClassName("beer")[48]
    .setAttribute("position", "71.5 20.8 -20.5");
  document
    .getElementsByClassName("beer")[49]
    .setAttribute("position", "69.87521 2.29658 60");
...
function appendScores() {
  if (score === 3000) {
    ...
    document.getElementById("highscores").innerHTML =
      "HIGHSCORES: <br>" + arr.join("");
    document.getElementById("highscores2").innerHTML =
      "HIGHSCORES: <br>" + arr.join("");
